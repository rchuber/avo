...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let SeniorDashboardViewController0 = SeniorDashboardViewController(nibName: "SeniorDashboardViewController", bundle: nil)
        ...
        let SeniorDashboardViewController1 = SeniorDashboardViewController(nibName: "SeniorDashboardViewController", bundle: nil)
        ...
        let SeniorDashboardViewController2 = SeniorDashboardViewController(nibName: "SeniorDashboardViewController", bundle: nil)
